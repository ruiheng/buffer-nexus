...
run_check "scripts/new_file_edit_refresh_check.lua"
...
run_check "scripts/logger_path_expand_check.lua"
...
run_check "scripts/pick_close_multigroup_test.lua"
run_check "scripts/pick_command_popup_mode_test.lua"
